...
const TopProductTable = () => {
    const tableActionData: TableAction[] = [
        { icon: FolderPlus, listtitle: "Добавить" },
        { icon: FolderPen, listtitle: "Изменить" },
        { icon: FolderMinus, listtitle: "Удалить" },
    ];
    ...
    return (
        <Card className="w-full border-0 overflow-hidden pb-0 h-full">
            <CardHeader>
                <CardTitle>Топ проекты</CardTitle>
                <CardDescription>Статистика лучших проектов</CardDescription>
            </CardHeader>
                    ...
                    <Table className="min-w-2xl">
                        <TableHeader>
                            <TableRow className="hover:bg-transparent!">
                                ...
                                <TableHead className="p-2">Проект</TableHead>
                                <TableHead className="p-2">Бюджет</TableHead>
                                <TableHead className="p-2">Менеджер</TableHead>
                                <TableHead className="p-2">Прогресс</TableHead>
                                <TableHead className="p-3 pe-6 flex justify-end">Действие</TableHead>
                            </TableRow>
                        </TableHeader>
