...
const partnerRoster: { name: string; avatar: string }[] = [
    { name: "Мухаммед Али", avatar: "https://images.shadcnspace.com/assets/profiles/user-1.jpg" },
    { name: "Майк Тайсон", avatar: "https://images.shadcnspace.com/assets/profiles/user-2.jpg" },
    { name: "Рой Джонс", avatar: "https://images.shadcnspace.com/assets/profiles/user-3.jpg" },
    { name: "Бернард Хопкинс", avatar: "https://images.shadcnspace.com/assets/profiles/user-4.jpg" },
    { name: "Эвандер Холифилд", avatar: "https://images.shadcnspace.com/assets/profiles/user-5.jpg" },
    { name: "Флойд Мейвезер", avatar: "https://images.shadcnspace.com/assets/profiles/user-6.jpg" },
    { name: "Мэнни Пакьяо", avatar: "https://images.shadcnspace.com/assets/profiles/user-7.jpg" },
    { name: "Сауль Альварес", avatar: "https://images.shadcnspace.com/assets/profiles/user-8.jpg" },
    { name: "Геннадий Головкин", avatar: "https://images.shadcnspace.com/assets/profiles/user-9.jpg" },
    { name: "Владимир Кличко", avatar: "https://images.shadcnspace.com/assets/profiles/user-10.jpg" },
    { name: "Джо Льюис", avatar: "https://images.shadcnspace.com/assets/profiles/user-11.jpg" },
    { name: "Александр Усик", avatar: "https://images.shadcnspace.com/assets/profiles/user-12.jpg" },
    { name: "Василий Ломаченко", avatar: "https://images.shadcnspace.com/assets/profiles/user-13.jpg" },
    { name: "Теренс Кроуфорд", avatar: "https://images.shadcnspace.com/assets/profiles/user-14.jpg" },
    { name: "Эррол Спенс", avatar: "https://images.shadcnspace.com/assets/profiles/user-15.jpg" },
    { name: "Дмитрий Бивол", avatar: "https://images.shadcnspace.com/assets/profiles/user-16.jpg" },
    { name: "Артур Бетербиев", avatar: "https://images.shadcnspace.com/assets/profiles/user-17.jpg" },
    { name: "Тайсон Фьюри", avatar: "https://images.shadcnspace.com/assets/profiles/user-18.jpg" },
    { name: "Энтони Джошуа", avatar: "https://images.shadcnspace.com/assets/profiles/user-19.jpg" },
    { name: "Деонтей Уайлдер", avatar: "https://images.shadcnspace.com/assets/profiles/user-20.jpg" },
    { name: "Леннокс Льюис", avatar: "https://images.shadcnspace.com/assets/profiles/user-1.jpg" },
    { name: "Джо Фрейзер", avatar: "https://images.shadcnspace.com/assets/profiles/user-2.jpg" },
    { name: "Джордж Форман", avatar: "https://images.shadcnspace.com/assets/profiles/user-3.jpg" },
    { name: "Шугар Рэй Леонард", avatar: "https://images.shadcnspace.com/assets/profiles/user-4.jpg" },
    { name: "Шугар Рэй Робинсон", avatar: "https://images.shadcnspace.com/assets/profiles/user-5.jpg" },
    { name: "Марвин Хаглер", avatar: "https://images.shadcnspace.com/assets/profiles/user-6.jpg" },
    { name: "Томас Хирнс", avatar: "https://images.shadcnspace.com/assets/profiles/user-7.jpg" },
    { name: "Роберто Дюран", avatar: "https://images.shadcnspace.com/assets/profiles/user-8.jpg" },
    { name: "Оскар Де Ла Хойя", avatar: "https://images.shadcnspace.com/assets/profiles/user-9.jpg" },
    { name: "Хулио Сезар Чавес", avatar: "https://images.shadcnspace.com/assets/profiles/user-10.jpg" },
    { name: "Пернелл Уитакер", avatar: "https://images.shadcnspace.com/assets/profiles/user-11.jpg" },
    { name: "Феликс Тринидад", avatar: "https://images.shadcnspace.com/assets/profiles/user-12.jpg" },
    { name: "Хуан Мануэль Маркес", avatar: "https://images.shadcnspace.com/assets/profiles/user-13.jpg" },
    { name: "Серхио Мартинес", avatar: "https://images.shadcnspace.com/assets/profiles/user-14.jpg" },
    { name: "Джо Кальзаге", avatar: "https://images.shadcnspace.com/assets/profiles/user-15.jpg" },
    { name: "Карл Фроч", avatar: "https://images.shadcnspace.com/assets/profiles/user-16.jpg" },
    { name: "Насим Хамед", avatar: "https://images.shadcnspace.com/assets/profiles/user-17.jpg" },
    { name: "Рикки Хаттон", avatar: "https://images.shadcnspace.com/assets/profiles/user-18.jpg" },
    { name: "Амир Хан", avatar: "https://images.shadcnspace.com/assets/profiles/user-19.jpg" },
    { name: "Костя Цзю", avatar: "https://images.shadcnspace.com/assets/profiles/user-20.jpg" },
    { name: "Заб Джуда", avatar: "https://images.shadcnspace.com/assets/profiles/user-1.jpg" },
    { name: "Шейн Мозли", avatar: "https://images.shadcnspace.com/assets/profiles/user-2.jpg" },
    { name: "Дэвид Туа", avatar: "https://images.shadcnspace.com/assets/profiles/user-3.jpg" },
    { name: "Сонни Листон", avatar: "https://images.shadcnspace.com/assets/profiles/user-4.jpg" },
    { name: "Ларри Холмс", avatar: "https://images.shadcnspace.com/assets/profiles/user-5.jpg" },
];
...
const basePartners: BasePartner[] = partnerRoster.map((partner, index) => {
    ...
    const rng = createRng(seed + seedFromString("level2"));
